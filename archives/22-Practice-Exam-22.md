# 🎓 AWS Cloud Practitioner (CLF-C02) Practice Exam 22
...
*   **Correct Answer:** **A. Use multiple AWS accounts**
...
*   **Correct Answer:** **A. Spot Instances for stateless and flexible workloads** & **D. Reserved Instances for sustained workloads**
*   **Explanation:**
    *   **Spot Instances** (A) provide up to a 90% discount for fault-tolerant and stateless workloads.
