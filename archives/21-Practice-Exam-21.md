# 🎓 AWS Cloud Practitioner (CLF-C02) Practice Exam 21
...
*   **Correct Answer:** **D. Implementing consolidated billing** & **E. Enforcing the governance of AWS accounts**
*   **Explanation:**
    *   **Consolidated billing** (D) aggregates costs across all linked accounts.
...
*   **Correct Answer:** **D. Custom database schema and application security**
...
*   **Correct Answer:** **B. The built-in ability of an application's infrastructure to remain operational despite a component failure.**
