# 🎓 AWS Cloud Practitioner (CLF-C02) Practice Exam 16
...
*   **Correct Answer:** **B. AWS Total Cost of Ownership (TCO) Calculator**
...
*   **Correct Answer:** **B. Linked accounts and consolidated billing**
...
### **Question 4**
A company is designing an application hosted in a single AWS Region serving end-users spread across the world. The company wants to provide the end-users low latency access to the application data. Which of the following services will help?
*   A. Amazon Route 53
*   B. Amazon CloudFront
...
### **Question 5**
Which of the following can a customer use to configure backup schedules for Amazon EBS volumes?
...
### **Question 6**
Which AWS service is used to create and manage security keys?
...
### **Question 9**
Which service allows customers to easily design, deploy, and manage SSL/TLS certificates for their AWS-based applications?
...
*   **Correct Answer:** **A. Compute costs**, **B. Storage costs**, & **C. Network data transfer costs**
