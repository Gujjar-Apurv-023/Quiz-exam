# 🎓 AWS Cloud Practitioner (CLF-C02) Practice Exam 23
...
*   **Correct Answer:** **A. AWS Elastic Beanstalk** & **C. AWS OpsWorks**
*   **Explanation:**
    *   **AWS Elastic Beanstalk** (A) is a platform-as-a-service that manages application deployments automatically.
...
### **Question 50**
What is the AWS service that assists you in converting database schemas from one engine to another during a migration?
